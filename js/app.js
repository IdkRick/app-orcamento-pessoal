...
function cadastrarDespesa() {
   ...
   if(despesa.validarDados()) {
      ...
      document.getElementById('modal_titulo').innerHTML = 'Despesa inserida com sucesso'
      document.getElementById('modal_titulo_div').className = 'modal-header text-success'
      document.getElementById('modal_conteudo').innerHTML = 'Consulte suas despesas na página <strong>Consulta</strong>'
